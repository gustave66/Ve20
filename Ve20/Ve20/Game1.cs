...
namespace RogueWaves
{
    public class Game1 : Game
    {
        ...
        //Set first State
        State gameState = State.Boarding;
        #endregion
        ...
        public Game1()
        {
            ...
            graphics.PreferredBackBufferHeight = 360 * 3;
            graphics.PreferredBackBufferWidth = 640 * 3;
        ...
        protected override void LoadContent()
        {
            ...
            //new animation player and particle engine test
            Texture2D texture = Content.Load<Texture2D>("pack");
            animatedSprite = new AnimatedSprite(texture, 4, 6, 1);

            List<Texture2D> textures = new List<Texture2D>();
            textures.Add(Content.Load<Texture2D>("circle"));
            textures.Add(Content.Load<Texture2D>("square"));
            textures.Add(Content.Load<Texture2D>("triangle"));
                ...
                case State.Boarding:
                    {
                       ...
                       // foreach (EnemyKnight badie in enemyKnights)
                        ...
                        //new particle engine and animation style
                        spriteBatch.End();
