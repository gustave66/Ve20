...
{
    internal class PlatformerHUD
    {
        Texture2D healthTexture;
        public int playerPosInfo, screenWidth, screenHeight, playerHealth, enemyHealth, stunnedCheck;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (showHUD == true)
            {
                spriteBatch.DrawString(playerHUDFont, "Put useful info here,  " + playerPos.X + ", "+ playerPos.Y, MainHUDpos, Color.Green);
